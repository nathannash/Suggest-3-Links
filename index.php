		    ...
		    <form class="form-signin" method="post" action="suggest.php"> 
		         ...
		         <p>
				      <?php
						...
						----------------------------------------------------------*/
						//interest 1
					    echo '<input type="checkbox" class="check-design" name="interests[]" value="Design" />';
					    echo '<label for="check-design">Design</label>';
					    //interest 2
					    echo '<input type="checkbox" class="check-webdevelopment" name="interests[]" value="Web Development"/>';
					    echo '<label for="check-webdevelopment">Web Development</label>';
					    //interest 3
					    echo '<input type="checkbox" class="check-startups" name="interests[]"  value="Startups"/>';
					    echo '<label for="check-startups">Startups</label>';		   
					    //interest 4
					    echo '<input type="checkbox" class="check-videogames" name="interests[]"value="Video Games" />';
					    echo '<label for="check-videogames">Video Games</label>';				   
					    //interest 5
					    echo '<input type="checkbox" class="check-onlinemagazines" name="interests[]" value="Online Magazines" />';
